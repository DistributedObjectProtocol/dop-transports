;(function(root) {
    function local(dop, node, options) {
        ...
        function onmessage(message) {
            ...
            } else dop.core.emitMessage(node, message)
        }
        function onclose() {
            readyState = CLOSE
    ...
    function api(dop, server) {
        ...
        socket.server.close = socket.client.close = function(message) {
            socket.server.readyState = socket.client.readyState = CLOSE
    ...
    if (typeof module == 'object' && module.exports) module.exports = local
    else {
